...
let player = new Player(x, y, 10, 'white') // <-player sett
let projectiles = []
let enemies = []
let particles = []
...
function animate() {
    ...
    c.fillStyle = 'rgba(0, 0, 0, 0.1)' //<- fade fx
        ...
        projectiles.forEach((projectile, projectileIndex) => {
            ...
            if (dist - enemy.radius - projectile.radius < 1) 
            {
                ...
                scoreEl.innerHTML = score
                    ...
                    gsap.to(enemy,{
                        radius: enemy.radius - 10  //dmg
                    })
                    setTimeout(() => {
                        projectiles.splice(projectileIndex, 1)
                    }, 0)                   
                } else {
                    //remove from sence altogether
                    score +=250
                    scoreEl.innerHTML = score
